...
export default function FoundersForge() {
  ...
  const handleClaimSpot = (tier: string = "founding") => {
    const stripeUrls = {
      founding: import.meta.env.VITE_STRIPE_FOUNDING_MEMBER_URL || "https://buy.stripe.com/cNifZickH7yQ05A2pt8Ra00",
      supporter: import.meta.env.VITE_STRIPE_SUPPORTER_URL || "https://buy.stripe.com/3cI00kaczcTag4y6FJ8Ra01",
      waitlist: "/waitlist"
    };
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-gradient-to-b from-background via-background to-muted/30">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            Join the first visionaries who'll shape the AI-powered coding platform of the future.
            <br />
                ...
                <Card className={`h-full relative overflow-hidden ${tier.highlighted ? 'border-primary shadow-lg' : ''}`}>
                  ...
                  <CardContent className="relative">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        if (tier.name === "Founding Member") {
                          handleClaimSpot("founding");
                        } else if (tier.name === "Supporter") {
                          handleClaimSpot("supporter");
                        } else {
